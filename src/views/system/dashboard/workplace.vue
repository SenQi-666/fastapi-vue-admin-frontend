...
export default {
  ...
  setup() {
    ...
    const projectItems = [
      { title: 'Ant Design', avatar: 'https://gw.alipayobjects.com/zos/rmsportal/dURIMkkrRFpPgTuzkwnB.png', description: '城镇中有那么多的酒馆，她却偏偏走进了我的酒馆', author: '中二少女团', datetime: '几秒前' },
    ...
    const teams = [
      { avatar: 'https://gw.alipayobjects.com/zos/rmsportal/dURIMkkrRFpPgTuzkwnB.png', name: '中二少女团' },
